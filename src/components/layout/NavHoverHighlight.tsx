  ...
  return (
    ...
    >
      <span
        ref={highlightRef}
        aria-hidden
        className="pointer-events-none absolute left-0 top-0 z-0 h-0 w-0 rounded-full bg-crimson/10 opacity-0 transition-[transform,width,height,opacity] duration-300 ease-club"
      />
      {children}
    </ul>
  );
