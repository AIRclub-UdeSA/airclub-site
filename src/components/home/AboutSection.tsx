  ...
  return (
    <section id="nosotros" className="px-6 sm:px-10 md:px-16 min-h-[calc(100vh-4.5rem)] flex items-center justify-center max-w-[1400px] mx-auto py-12 w-full">
      <RevealOnScroll className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-20 items-center w-full">
          {/* Lado izquierdo: Declaración tipográfica monumental de gran fuerza posicionada a la izquierda */}
          <div className="lg:col-span-6 xl:col-span-6 text-left">
            <h2 className="font-display text-[clamp(2.4rem,4.4vw,4.4rem)] font-black leading-[0.92] tracking-tight text-text uppercase text-left">
              Construir.
              <br />
          ...
          {/* Lado derecho: Párrafo editorial y enlace al equipo */}
          <div className="lg:col-span-6 xl:col-span-5 lg:col-start-7 xl:col-start-8 flex flex-col justify-center text-left">
            <p className="font-body text-[1.05rem] sm:text-[1.14rem] leading-[1.8] text-text2 mb-6">
